...
extern "C" WEBCORE_EXPORT void* FillLayer_image(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t FillLayer_attachment(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t FillLayer_maskMode(const void* p)
{
