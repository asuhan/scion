...
extern "C" WEBCORE_EXPORT const void* RenderStyle_pseudoElementNameArgument(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->pseudoElementNameArgument();
}
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_position(const void* p)
{
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_minWidth(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->minWidth();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_maxWidth(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->maxWidth();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_minHeight(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->minHeight();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_maxHeight(const void* p)
{
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_logicalMinWidth(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->logicalMinWidth();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_logicalMaxWidth(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->logicalMaxWidth();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_logicalMinHeight(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->logicalMinHeight();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_logicalMaxHeight(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->logicalMaxHeight();
}
...
extern "C" WEBCORE_EXPORT float RenderStyle_borderEndWidth(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->borderEndWidth();
}
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_fontDescription(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_rtlOrdering(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_display(const void* p)
{
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_maskLayers(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->maskLayers();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_maskBorder(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->maskBorder();
}
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_emptyCells(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->emptyCells());
}

extern "C" WEBCORE_EXPORT uint8_t RenderStyle_captionSide(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_boxDecorationBreak(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->boxDecorationBreak());
}
...
extern "C" WEBCORE_EXPORT bool RenderStyle_hasInlineColumnAxis(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_hasAutoColumnCount(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->hasAutoColumnCount();
}
...
extern "C" WEBCORE_EXPORT float RenderStyle_transformOriginZ(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_rubyOverhang(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->rubyOverhang());
}

extern "C" WEBCORE_EXPORT uint8_t RenderStyle_textOrientation(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_textSecurity(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->textSecurity());
}
...
extern "C" WEBCORE_EXPORT bool RenderStyle_isVerticalWritingMode(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_imageRendering(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->imageRendering());
}
...
extern "C" WEBCORE_EXPORT bool RenderStyle_hasAppleColorFilter(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->hasAppleColorFilter();
}
...
extern "C" WEBCORE_EXPORT bool RenderStyle_isolation(const void* p)
{
    return static_cast<bool>(static_cast<const WebCore::RenderStyle*>(p)->isolation());
}

extern "C" WEBCORE_EXPORT bool RenderStyle_usesStandardScrollbarStyle(const void* p)
{
...
extern "C" WEBCORE_EXPORT void RenderStyle_setAlignSelfPosition(const void* p, uint8_t position)
{
    static_cast<WebCore::RenderStyle*>(const_cast<void*>(p))->setAlignSelfPosition(static_cast<WebCore::ItemPosition>(position));
}

extern "C" WEBCORE_EXPORT void RenderStyle_setFlexDirection(const void* p, uint8_t direction)
{
    static_cast<WebCore::RenderStyle*>(const_cast<void*>(p))->setFlexDirection(static_cast<WebCore::FlexDirection>(direction));
}

extern "C" WEBCORE_EXPORT void RenderStyle_setFlexWrap(const void* p, uint8_t wrap)
{
    static_cast<WebCore::RenderStyle*>(const_cast<void*>(p))->setFlexWrap(static_cast<WebCore::FlexWrap>(wrap));
}

extern "C" WEBCORE_EXPORT void RenderStyle_setColumnSpan(const void* p, bool span)
{
...
extern "C" WEBCORE_EXPORT LayoutBoxExtentRaw RenderStyle_borderImageOutsets(const void* p)
{
    const auto extent = static_cast<const WebCore::RenderStyle*>(p)->borderImageOutsets();
    return { extent.top().rawValue(), extent.right().rawValue(), extent.bottom().rawValue(), extent.left().rawValue() };
}
...
extern "C" WEBCORE_EXPORT bool RenderStyle_hasVisibleBorder(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->hasVisibleBorder();
}

extern "C" WEBCORE_EXPORT bool RenderStyle_hasPadding(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_hasAnyFixedBackground(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->hasAnyFixedBackground();
}

extern "C" WEBCORE_EXPORT bool RenderStyle_hasEntirelyFixedBackground(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->hasEntirelyFixedBackground();
}
...
extern "C" WEBCORE_EXPORT bool RenderStyle_hasBorderRadius(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->hasBorderRadius();
}

extern "C" WEBCORE_EXPORT bool RenderStyle_hasOutline(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_isOverflowVisible(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_preserveNewline(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_hyphens(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->hyphens());
}
...
extern "C" WEBCORE_EXPORT bool RenderStyle_columnSpan(const void* p)
{
    return static_cast<bool>(static_cast<const WebCore::RenderStyle*>(p)->columnSpan());
}

extern "C" WEBCORE_EXPORT uint16_t RenderStyle_columnCount(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->columnCount();
}

extern "C" WEBCORE_EXPORT uint8_t RenderStyle_columnRuleStyle(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_columnRuleIsTransparent(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->columnRuleIsTransparent();
}
...
extern "C" WEBCORE_EXPORT void RenderStyle_setPosition(const void* p, uint8_t v)
{
    static_cast<WebCore::RenderStyle*>(const_cast<void*>(p))->setPosition(static_cast<WebCore::PositionType>(v));
}

extern "C" WEBCORE_EXPORT void RenderStyle_setTextAlign(const void* p, uint8_t v)
{
    static_cast<WebCore::RenderStyle*>(const_cast<void*>(p))->setTextAlign(static_cast<WebCore::TextAlignMode>(v));
}

extern "C" WEBCORE_EXPORT void RenderStyle_setDirection(const void* p, bool v)
{
    static_cast<WebCore::RenderStyle*>(const_cast<void*>(p))->setDirection(v ? WebCore::TextDirection::RTL : WebCore::TextDirection::LTR);
}
...
extern "C" WEBCORE_EXPORT float RenderStyle_usedZoom(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->usedZoom();
}

extern "C" WEBCORE_EXPORT uint8_t RenderStyle_textWrapStyle(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_backgroundSizeType(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_backfaceVisibility(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->backfaceVisibility());
}

extern "C" WEBCORE_EXPORT float RenderStyle_perspective(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_hasPerspective(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->hasPerspective();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_perspectiveOriginX(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->perspectiveOriginX();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_perspectiveOriginY(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->perspectiveOriginY();
}
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_textDecorationStyle(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->textDecorationStyle());
}
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_borderLeftStyle(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->borderLeftStyle());
}

extern "C" WEBCORE_EXPORT bool RenderStyle_borderLeftIsTransparent(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->borderLeftIsTransparent();
}
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_borderRightStyle(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_borderTopStyle(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_borderBottomIsTransparent(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->borderBottomIsTransparent();
}
...
extern "C" WEBCORE_EXPORT float RenderStyle_outlineWidth(const void* p)
{
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_marginBottom(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->marginBottom();
}
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_marginStart(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->marginStart();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_marginBefore(const void* p)
{
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_marginEnd(const void* p)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->marginEnd();
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_marginStartUsing(const void* p, const void* other_style_raw)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->marginStartUsing(static_cast<const WebCore::RenderStyle*>(other_style_raw));
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_marginEndUsing(const void* p, const void* other_style_raw)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->marginEndUsing(static_cast<const WebCore::RenderStyle*>(other_style_raw));
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_marginBeforeUsing(const void* p, const void* other_style_raw)
{
    return &static_cast<const WebCore::RenderStyle*>(p)->marginBeforeUsing(static_cast<const WebCore::RenderStyle*>(other_style_raw));
}

extern "C" WEBCORE_EXPORT const void* RenderStyle_marginAfterUsing(const void* p, const void* other_style_raw)
{
...
extern "C" WEBCORE_EXPORT double RenderStyle_aspectRatioLogicalWidth(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->aspectRatioLogicalWidth();
}

extern "C" WEBCORE_EXPORT double RenderStyle_aspectRatioLogicalHeight(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_hasAspectRatio(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->hasAspectRatio();
}

extern "C" WEBCORE_EXPORT uint8_t RenderStyle_boxAlign(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->boxAlign());
}

extern "C" WEBCORE_EXPORT float RenderStyle_boxFlex(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_boxLines(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint32_t RenderStyle_gridAutoRepeatColumnsInsertionPoint(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->gridAutoRepeatColumnsInsertionPoint();
}

extern "C" WEBCORE_EXPORT uint32_t RenderStyle_gridAutoRepeatRowsInsertionPoint(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint64_t RenderStyle_namedGridAreaRowCount(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->namedGridAreaRowCount();
}

extern "C" WEBCORE_EXPORT uint64_t RenderStyle_namedGridAreaColumnCount(const void* p)
{
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_paddingBefore(const void* p)
{
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_paddingStart(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_insideLink(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint16_t RenderStyle_widows(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_hasAutoWidows(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->hasAutoWidows();
}

extern "C" WEBCORE_EXPORT bool RenderStyle_hasAutoOrphans(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_containsPaint(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->containsPaint();
}

extern "C" WEBCORE_EXPORT bool RenderStyle_containsLayoutOrPaint(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_usedContentVisibility(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->usedContentVisibility());
}

extern "C" WEBCORE_EXPORT bool RenderStyle_hasSkippedContent(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_containIntrinsicLogicalWidthHasAuto(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->containIntrinsicLogicalWidthHasAuto();
}

extern "C" WEBCORE_EXPORT bool RenderStyle_containIntrinsicLogicalHeightHasAuto(const void* p)
{
...
extern "C" WEBCORE_EXPORT const void* RenderStyle_flexBasis(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderStyle_isRowFlexDirection(const void* p)
{
    return static_cast<const WebCore::RenderStyle*>(p)->isRowFlexDirection();
}

extern "C" WEBCORE_EXPORT bool RenderStyle_isColumnFlexDirection(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_boxSizing(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_userDrag(const void* p)
{
...
extern "C" WEBCORE_EXPORT uint8_t RenderStyle_usedTransformStyle3D(const void* p)
{
    return static_cast<uint8_t>(static_cast<const WebCore::RenderStyle*>(p)->usedTransformStyle3D());
}

extern "C" WEBCORE_EXPORT bool RenderStyle_preserves3D(const void* p)
{
...
{
    const auto other = static_cast<const WebCore::RenderStyle*>(other_raw);
    return static_cast<const WebCore::RenderStyle*>(p)->outOfFlowPositionStyleDidChange(other);
}
