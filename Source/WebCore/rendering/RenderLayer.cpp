...
extern "C" WEBCORE_EXPORT void* RenderLayer_parent(const void* p)
{
    return static_cast<const WebCore::RenderLayer*>(p)->parent();
}

extern "C" WEBCORE_EXPORT void* RenderLayer_commonAncestorWithLayer(const void* p, void* layer)
{
...
extern "C" WEBCORE_EXPORT bool RenderLayer_needsFullRepaint(const void* p)
{
    return static_cast<const WebCore::RenderLayer*>(p)->needsFullRepaint();
}
...
extern "C" WEBCORE_EXPORT void RenderLayer_setStaticInlinePosition(void* p, int32_t position)
{
    static_cast<WebCore::RenderLayer*>(p)->setStaticInlinePosition(WebCore::LayoutUnit::fromRawValue(position));
}

extern "C" WEBCORE_EXPORT void RenderLayer_setStaticBlockPosition(void* p, int32_t position)
{
...
extern "C" WEBCORE_EXPORT bool RenderLayer_isolatesBlending(const void* p)
{
    return static_cast<const WebCore::RenderLayer*>(p)->isolatesBlending();
}
...
extern "C" WEBCORE_EXPORT void* RenderLayer_backing(const void* p)
{
