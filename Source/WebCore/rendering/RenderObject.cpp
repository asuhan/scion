...
extern "C" WEBCORE_EXPORT void* RenderObject_nextSibling(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderObject_isOutOfFlowPositioned(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderObject_isInline(const void* p)
{
    return static_cast<const WebCore::RenderObject*>(p)->isInline();
}
...
extern "C" WEBCORE_EXPORT bool RenderObject_hasLayer(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderObject_needsPositionedMovementLayoutOnly(const void* p)
{
...
extern "C" WEBCORE_EXPORT void* RenderObject_document(const void* p)
{
...
extern "C" WEBCORE_EXPORT void* RenderObject_page(const void* p)
{
    return &static_cast<const WebCore::RenderObject*>(p)->page();
}

extern "C" WEBCORE_EXPORT void* RenderObject_settings(const void* p)
{
    return &static_cast<const WebCore::RenderObject*>(p)->settings();
}
...
{
    if (m_scion) { return m_scion->childAt(index); }
...
{
    if (m_scion) { return m_scion->firstLeafChild(); }
...
{
    if (m_scion) { return m_scion->lastLeafChild(); }
...
{
    if (m_scion) {
        m_scion->clearNeedsLayout(hadSkippedLayout);
        return;
    }
...
{
    if (m_scion) { return m_scion->localToAbsolute(localPoint, mode, wasFixed); }
...
{
    if (m_scion) { return m_scion->hitTest(request, result, locationInContainer, accumulatedOffset, hitTestFilter); }
    bool inside = false;
...
void RenderObject::setPosChildNeedsLayoutBit(bool b)
{
    if (m_scion) {
        m_scion->setPosChildNeedsLayoutBit(b);
        return;
    }
...
{
    if (m_scion) { return m_scion->isFixedPositioned(); }
...
bool RenderObject::isRenderDeprecatedFlexibleBox() const
{
    if (m_scion) { return m_scion->isRenderDeprecatedFlexibleBox(); }
