...
extern "C" WEBCORE_EXPORT void* RenderElement_element(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderElement_shouldApplyLayoutContainment(const void* p)
{
...
extern "C" WEBCORE_EXPORT bool RenderElement_hasOutline(const void* p)
{
    return static_cast<const WebCore::RenderElement*>(p)->hasOutline();
}
...
bool RenderElement::shouldApplyStyleContainment() const
{
    if (m_scion) { return m_scion->shouldApplyStyleContainment(); }
...
bool RenderElement::hasBackdropFilter() const
{
    if (m_scion) { return m_scion->hasBackdropFilter(); }
