...
class RenderStyleWrapper: Equatable {
  ...
  func minWidth() -> LengthWrapper { return LengthWrapper(p: wk_interop.RenderStyle_minWidth(p!)) }
  ...
  func logicalMinWidth() -> LengthWrapper {
    return LengthWrapper(p: wk_interop.RenderStyle_logicalMinWidth(p!))
  }

  func logicalMaxWidth() -> LengthWrapper {
    return LengthWrapper(p: wk_interop.RenderStyle_logicalMaxWidth(p!))
  }
  ...
  func borderImageOutsets() -> LayoutBoxExtent {
    return convertLayoutBoxExtentRaw(wk_interop.RenderStyle_borderImageOutsets(p!))
  }
  ...
  func overscrollBehaviorX() -> OverscrollBehavior {
    return OverscrollBehavior(rawValue: wk_interop.RenderStyle_overscrollBehaviorX(p!))!
  }

  func overscrollBehaviorY() -> OverscrollBehavior {
    return OverscrollBehavior(rawValue: wk_interop.RenderStyle_overscrollBehaviorY(p!))!
  }
  ...
  func marginStart() -> LengthWrapper {
    return LengthWrapper(p: wk_interop.RenderStyle_marginStart(p!))
  }
  ...
  func marginEnd() -> LengthWrapper {
    return LengthWrapper(p: wk_interop.RenderStyle_marginEnd(p!))
  }

  func marginStartUsing(otherStyle: RenderStyleWrapper) -> LengthWrapper {
    return LengthWrapper(p: wk_interop.RenderStyle_marginStartUsing(p!, otherStyle.p!))
  }

  func marginEndUsing(otherStyle: RenderStyleWrapper) -> LengthWrapper {
    return LengthWrapper(p: wk_interop.RenderStyle_marginEndUsing(p!, otherStyle.p!))
  }
  ...
  func aspectRatioLogicalWidth() -> Float64 {
    return wk_interop.RenderStyle_aspectRatioLogicalWidth(p!)
  }

  func aspectRatioLogicalHeight() -> Float64 {
    return wk_interop.RenderStyle_aspectRatioLogicalHeight(p!)
  }
  ...
  func gridAutoRepeatColumnsType() -> AutoRepeatType {
    return AutoRepeatType(rawValue: wk_interop.RenderStyle_gridAutoRepeatColumnsType(p!))!
  }
  ...
  func isGridAutoFlowDirectionColumn() -> Bool {
    return wk_interop.RenderStyle_isGridAutoFlowDirectionColumn(p!)
  }
  ...
  func columnRuleWidth() -> UInt16 { return wk_interop.RenderStyle_columnRuleWidth(p!) }

  func columnRuleIsTransparent() -> Bool {
    return wk_interop.RenderStyle_columnRuleIsTransparent(p!)
  }
  ...
  func borderLeftStyle() -> BorderStyle {
    return BorderStyle(rawValue: wk_interop.RenderStyle_borderLeftStyle(p!))!
  }

  func borderLeftIsTransparent() -> Bool {
    return wk_interop.RenderStyle_borderLeftIsTransparent(p!)
  }
  ...
  func borderRightIsTransparent() -> Bool {
    return wk_interop.RenderStyle_borderRightIsTransparent(p!)
  }
  ...
  func borderTopStyle() -> BorderStyle {
    return BorderStyle(rawValue: wk_interop.RenderStyle_borderTopStyle(p!))!
  }

  func borderTopIsTransparent() -> Bool { return wk_interop.RenderStyle_borderTopIsTransparent(p!) }
  ...
  func containsStyle() -> Bool { return usedContain().contains(.Style) }
  ...
  func usedPointerEvents() -> PointerEvents {
    return PointerEvents(rawValue: wk_interop.RenderStyle_usedPointerEvents(p!))!
  }
  ...
  func offsetDistance() -> LengthWrapper {
    return LengthWrapper(p: wk_interop.RenderStyle_offsetDistance(p!))
  }
  ...
  func offsetAnchor() -> LengthPoint {
    let anchor = wk_interop.RenderStyle_offsetAnchor(p!)
    return LengthPoint(x: LengthWrapper(p: anchor.x), y: LengthWrapper(p: anchor.y))
  }
