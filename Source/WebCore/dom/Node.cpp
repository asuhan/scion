...
extern "C" WEBCORE_EXPORT bool Node_hasFieldsetTagName(const void* raw)
{
    return static_cast<const WebCore::Node*>(raw)->hasTagName(WebCore::HTMLNames::fieldsetTag);
}
...
extern "C" WEBCORE_EXPORT bool Node_hasMarqueeTagName(const void* raw)
{
    return static_cast<const WebCore::Node*>(raw)->hasTagName(WebCore::HTMLNames::marqueeTag);
}
...
extern "C" WEBCORE_EXPORT bool Node_hasCustomStyleResolveCallbacks(const void* raw)
{
