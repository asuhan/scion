...
extern "C" WEBCORE_EXPORT bool Element_hasNowrapAttr(const void* p)
{
    return static_cast<const WebCore::Element*>(p)->hasAttributeWithoutSynchronization(WebCore::HTMLNames::nowrapAttr);
}

extern "C" WEBCORE_EXPORT bool Element_hasAltAttr(const void* p)
{
...
extern "C" void Element_clearBeforePseudoElement(void* p) {
    return static_cast<WebCore::Element*>(p)->clearBeforePseudoElement();
}

extern "C" void Element_clearAfterPseudoElement(void* p) {
