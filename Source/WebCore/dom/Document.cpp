...
extern "C" WEBCORE_EXPORT void* Document_frame(const void* raw)
{
    return static_cast<const WebCore::Document*>(raw)->frame();
}

extern "C" WEBCORE_EXPORT void* Document_documentElement(const void* raw)
{
...
extern "C" WEBCORE_EXPORT bool Document_renderTreeBeingDestroyed(const void* raw)
{
...
extern "C" WEBCORE_EXPORT bool Document_inNoQuirksMode(const void* raw)
{
    return static_cast<const WebCore::Document*>(raw)->inNoQuirksMode();
}
...
extern "C" WEBCORE_EXPORT uint8_t Document_backForwardCacheState(const void* raw)
{
...
extern "C" WEBCORE_EXPORT bool Document_hasViewTransitionPseudoElementTree(const void* raw)
{
...
extern "C" WEBCORE_EXPORT void* Document_highlightRegistryIfExists(void* raw)
{
...
extern "C" WEBCORE_EXPORT bool Settings_caretBrowsingEnabled(const void* raw)
{
...
extern "C" WEBCORE_EXPORT bool Settings_cssScrollAnchoringEnabled(const void* raw)
{
    return static_cast<const WebCore::Settings*>(raw)->cssScrollAnchoringEnabled();
}
...
extern "C" WEBCORE_EXPORT bool Settings_imageSubsamplingEnabled(const void* raw)
{
...
extern "C" WEBCORE_EXPORT bool Settings_largeImageAsyncDecodingEnabled(const void* raw)
{
    return static_cast<const WebCore::Settings*>(raw)->largeImageAsyncDecodingEnabled();
}
...
extern "C" WEBCORE_EXPORT bool Settings_showDebugBorders(const void* raw)
{
...
extern "C" WEBCORE_EXPORT bool Settings_userInterfaceDirectionPolicy(const void* raw)
{
