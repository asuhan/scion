...
void FloatQuadVector_append(void*, struct FloatQuadRaw);
...
float FontMetrics_descent(const void*, uint8_t);
...
int32_t FontCascade_emphasisMarkDescent(const void* font_cascade_ptr, const void* mark_ptr);
...
const void* Length_copy(const void*);
...
int32_t String_previousOffsetForBackwardDeletion(const void*, int32_t);
...
void* RenderObject_previousInFlowSibling(const void*);
void* RenderObject_nextInFlowSibling(const void*);
...
bool RenderObject_isLineBreakOpportunity(const void*);
...
void RenderObject_setNormalChildNeedsLayoutBit(void*, bool);
void RenderObject_setNeedsSimplifiedNormalFlowLayoutBit(void*, bool);
bool RenderObject_isSetNeedsLayoutForbidden(const void*);
...
struct LayoutSizeRaw RenderLayoutState_lineGridOffset(const void*);
struct LayoutSizeRaw RenderLayoutState_paintOffset(const void*);
struct LayoutSizeRaw RenderLayoutState_layoutOffset(const void*);
...
void RenderLayoutState_pushBlockStartTrimming(void*, bool);
struct OptionalBool RenderLayoutState_blockStartTrimming(const void*);
void RenderLayoutState_popBlockStartTrimming(void*);
...
const void* LocalFrame_editor(const void*);
...
struct SRGBARaw LocalFrameView_baseBackgroundColor(const void*);
...
void LocalFrameView_addViewportConstrainedObject(void*, void*);
void LocalFrameView_removeViewportConstrainedObject(void*, void*);
...
void RenderElement_removeLayers(void*);
...
void* RenderElement_lastChildSlow(const void*);
...
const void* RenderElement_firstLineStyle(const void*);
...
void RenderBox_clearOverridingContentSize(void*);
void RenderBox_clearOverridingLogicalHeight(void*);
void RenderBox_clearOverridingLogicalWidth(void*);
...
struct OptionalLayoutUnitRaw RenderBox_inlineBlockBaseline(const void*, bool);
...
bool originalTextMap_contains(const void*);
void* inlineWrapperForDisplayContentsMap_get(const void*);
void inlineWrapperForDisplayContentsMap_add(const void*, void*);
void inlineWrapperForDisplayContentsMap_remove(const void*);
bool inlineWrapperForDisplayContentsMap_contains(const void*);
...
bool RenderStyle_hasPseudoStyle(const void*, uint32_t);
...
const struct GapLengthRaw RenderStyle_rowGap(const void*);
...
struct LayoutBoxExtentRaw RenderStyle_maskBorderOutsets(const void*);
...
struct SRGBARaw RenderStyle_computedStrokeColor(const void*);
...
const void* RenderStyle_offsetDistance(const void*);
...
void BoxGeometry_setHorizontalBorder(void*, struct BoxGeometryHorizontalEdgesRaw);
void BoxGeometry_setBorder(void* p, struct BoxGeometryEdgesRaw);
void BoxGeometry_setHorizontalPadding(void*, struct BoxGeometryHorizontalEdgesRaw);
...
bool isAlignedForUnderByStyle(const void*);
float computedUnderlineOffsetByStyle(const void*, bool, float, float);
...
void ScrollAnchoringController_notifyChildHadSuppressingStyleChange(void*);
bool ScrollAnchoringController_isInScrollAnchoringAncestorChain(void*, const void*);
...
void StyleImage_addClient(void*, void*);
void StyleImage_removeClient(void*, void*);
bool StyleImage_hasClient(const void*, void*);
...
uint8_t u_charDirection_scion(int32_t);
...
void* FloatingObjectSet_create();
void FloatingObjectSet_destroy(void*);
uint32_t FloatingObjectSet_size(const void*);
bool FloatingObjectSet_isEmpty(const void*);
void* FloatingObjectSet_begin(void*);
void* FloatingObjectSet_end(void*);
void* FloatingObjectSet_last(void*);
...
void FloatingObjectSet_clear(void*);
bool FloatingObjectSetIterator_atEnd(void*);
void* FloatingObjectSetIterator_deref(void*);
void FloatingObjectSetIterator_inc(void*);
void FloatingObjectSetIterator_dec(void*);
bool FloatingObjectSetIterator_eq(const void*, const void*);
...
void FloatingObjectTree_allOverlapsWithComputeFloatOffsetForFloatLayoutAdapter(const void*, void*);
void FloatingObjectTree_allOverlapsWithFindNextFloatLogicalBottomAdapter(const void* p, void*);
...
void* RenderLayer_parent(const void*);
void* RenderLayer_commonAncestorWithLayer(const void*, void*);
void RenderLayer_addChild(void*, void*, void*);
void RenderLayer_insertOnlyThisLayer(void*, bool);
void* RenderLayer_paintOrderParent(const void*);
...
bool RenderLayer_isTransparent(const void*);
bool RenderLayer_hasFilter(const void*);
void* RenderLayer_currentTransform(const void*);
...
uint32_t Document_styleColorOptions(const void* raw, const void* style_raw);
...
void* Document_bodyOrFrameset(const void*);
void* Document_markersIfExists(void*);
void* Document_topDocument(const void* raw);
uint8_t Document_backForwardCacheState(const void*);
void* Document_decoder(const void*);
...
void* Document_fragmentHighlightRegistryIfExists(void*);
...
bool FillLayer_isEmpty(const void*);
bool FillLayer_hasImage(const void*);
bool FillLayer_hasRepeatXY(const void*);
...
uint8_t ShapeValue_effectiveCSSBox(const void*);
...
void Page_addRelevantRepaintedObject(void*, const void*, struct LayoutRectRaw);
...
void GraphicsContext_fillRectWithRoundedHole(void*, struct FloatRectRaw, struct FloatRoundedRectRaw, struct SRGBARaw);
...
struct FloatSizeRaw GraphicsLayer_size(const void*);
...
bool HTMLOptionElement_selected(const void*, bool);
...
void* TransformationMatrix_multiply(void*, const void*);
...
struct ChangedContextSensitiveProperties RenderStyle_changeRequiresPositionedLayoutOnly(const void*, const void*);
struct ChangedContextSensitiveProperties RenderStyle_changeRequiresLayerRepaint(const void*, const void*);
struct ChangedContextSensitiveProperties RenderStyle_changeRequiresRepaint(const void*, const void*);
...
void InlineDisplayBoxScion_destroy(void*);
...
struct SRGBARaw RenderTheme_focusRingColor(const void*, uint32_t);
void* Path_create();
...
void Path_addLayoutRoundedRect(void*, struct RoundedRectRaw);
...
struct FloatRectRaw Path_fastBoundingRect(const void*);
struct FloatRectRaw Path_boundingRect(const void*);
